      ...
      <div className="start__wrapper">
        ...
        <div className="start__content">
          ...
          <div className="start__content-item">
            ...
            <span>
              Хочешь попрактиковаться на Java или C# - перепиши мое API на этих
              языках
            </span>
            <span>
            ...
            <span>
              Не нравится текущий дизайн сайта - перерисуй, а я сверстаю
            </span>
            <span>
              Нашел баг или не согласен с тем, как я что-то реализовал - пиши
              мне, разберемся на ходу
            </span>
          </div>
        </div>
