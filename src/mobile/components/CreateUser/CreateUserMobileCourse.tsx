...
const CreateUserMobileCourse = ({
  ...
  return (
    <div
      className={
        mount
          ? [classes['createUser__select-group'], classes['createUser__select-groupActive']].join(
              ' ',
            )
          : [classes['createUser__select-group'], classes['createUser__select-groupInactive']].join(
              ' ',
            )
      }
    >
