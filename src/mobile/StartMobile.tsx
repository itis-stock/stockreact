    ...
    <div className={classes['start']}>
      <div className={classes['start__page']}>
        ...
        <div className={[classes['start__item'], classes['item']].join(' ')}>
          <div className={[classes['start__item-title'], classes['title']].join(' ')}>Что?</div>
          <div className={[classes['start__item-text'], classes['text']].join(' ')}>
            Хз, что тут объяснять. Твердо и четко. Новый сток
          </div>
        </div>
        <div className={[classes['start__item'], classes['item']].join(' ')}>
          <div className={[classes['start__item-title'], classes['title']].join(' ')}>Зачем?</div>
          <div className={[classes['start__item-text'], classes['text']].join(' ')}>
            Просто потому что могу и мне похуй в принципе
          </div>
        </div>
        <div className={classes['start__info']}>
          <a href="https://github.com/itis-stock" className={classes['start__github']}>
          ...
          <a href="https://t.me/lld4n" className={classes['start__telegram']}>
            <div className={classes['start__telegram-text']}>Telegram разработчика</div>
        ...
        <p className={classes['start__info-text']}>
          Ты можешь разработать своё приложение на основе моего API, будь то Android-приложение или
          бот для Telegram. Можно создать буквально всё, что ты захочешь.
        </p>
        <a
          href={
